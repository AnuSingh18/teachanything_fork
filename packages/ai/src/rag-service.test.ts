...
// Mock officeparser at module level — Vitest hoists vi.mock() calls
...
describe("extractPowerPoint", () => {
  ...
  let mockParseOffice: ReturnType<typeof vi.fn>;

  beforeEach(async () => {
    service = new RAGService();
    const officeparser = await import("officeparser");
    mockParseOffice = officeparser.parseOffice as ReturnType<typeof vi.fn>;
      ...
      buildMockAST([
        {
          ...
          slideNumber: 1,
          children: [
            { type: "paragraph", text: "Clean\0text\0here" },
          ],
        },
      ]),
    );
